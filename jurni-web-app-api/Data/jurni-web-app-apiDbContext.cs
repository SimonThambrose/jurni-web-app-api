...
public class JurniWebAppApiDbContext : DbContext
{
     ...
     */
    public JurniWebAppApiDbContext(DbContextOptions<JurniWebAppApiDbContext> options) : base(options)
    {
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Plan>(plan =>
        {
            ...
            plan.HasData(new Plan()
            {
                ...
                Description =
                    "Unlimited matches per day, with additional features and support. Response within 72 hours."
            });
        });
